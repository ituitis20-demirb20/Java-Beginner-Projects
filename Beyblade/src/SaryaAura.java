 ...
 * @author burakdemir
 */
public class SaryaAura extends Beyblade {
    private String holyBeast="Saryaaura";
   

    public SaryaAura(String beyblader, String beybladeName, int power, int speed,String holyBeast) {
