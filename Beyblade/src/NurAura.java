 ...
 * @author burakdemir
 */
public class NurAura extends Beyblade {
    private String holyBeast="Nuraura";
   

    public NurAura(String beyblader, String beybladeName, int power, int speed,String holyBeast) {
